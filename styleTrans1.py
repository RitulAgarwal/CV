...
def VGG16_AvgPool(shape):
  ...
  # so replace maxpool with avgpool because maxppool throws away information
  # but avg sums up all data and has gloabl al info 
...
#   see the image
  ...
  plt.savefig('contentRECREATE10.png')
  plt.show()
